...
import { CTA_CROPS } from '@/content/home';

/** Closing call-to-action framed like a pinned parchment notice. */
export function CallToAction() {
  return (
    <section id="guide" className="relative overflow-hidden px-6 pt-20 pb-[72px]">
      <div
        aria-hidden
        className="pointer-events-none absolute top-1/2 left-1/2 size-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgb(220_190_80_/_0.15)_0%,transparent_60%)]"
      />
      ...
      <div className="relative mx-auto max-w-[640px] text-center">
        ...
        <div className="parchment relative rounded-none border-[3px] border-wood/40 px-10 pt-[42px] pb-[38px] shadow-pixel-lg">
          <span
            aria-hidden
            className="pointer-events-none absolute inset-[6px] border border-dashed border-wood/20"
          />
